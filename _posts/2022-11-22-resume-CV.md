...
> * **Professional Portfolio & Development:** Created a Python program that compares a dictionary file with a text file and compiles a list of matches with frequency of occurrence [<img src="/assets/images/octocat.PNG" width="2%" height="2%"/> **Github Project** \(_keycollator_\)](https://github.com/davidprush/keycollator) [<img src="/assets/images/Pypi.PNG" width="2%" height="2%"/> **\*pypi** \(_pip\) repo_\:keycollator](https://pypi.org/project/keycollator/)
